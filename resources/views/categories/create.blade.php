        ...
        <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">Organiza tus productos creando una nueva categoría con su color distintivo</p>
                </div>
            </div>
        </div>
        
        <form method="POST" action="{{ route('categories.store') }}" class="p-6 space-y-8" id="category-form">
            @csrf
                ...
                <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-6 border border-gray-200">
                    <div class="flex items-center space-x-4">
                        <div class="h-12 w-12 rounded-xl flex items-center justify-center shadow-sm border border-gray-200" 
                            ...
                            <i class="fas fa-tag text-lg" style="color: #3B82F6;"></i>
                        </div>
                        <div class="flex-1">
                            <div class="text-lg font-semibold text-gray-900" id="preview-name">Nombre de la categoría</div>
                            <div class="text-sm text-gray-600" id="preview-description">Descripción de la categoría</div>
                            <div class="mt-2">
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium" 
                                      id="preview-badge" 
                                      style="background-color: #3B82F620; color: #3B82F6;">
                                    <i class="fas fa-circle mr-1" style="color: #3B82F6;"></i>
                                    Categoría activa
                                </span>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (colorOptions.length > 0) {
        colorOptions[0].classList.add('ring-2', 'ring-blue-500');
    }
});
</script>
@endpush
