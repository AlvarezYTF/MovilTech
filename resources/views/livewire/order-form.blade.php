        ...
        <tbody>
            @foreach ($invoiceProducts as $index => $invoiceProduct)
                <tr>
                    ...
                    <td class="align-middle text-center">
                        @if ($invoiceProduct['is_saved'])
                        <input type="number" wire:model="invoiceProducts.{{ $index }}.product_price"
                            id="invoiceProducts[{{ $index }}][unitcost]" class="form-control" />
                        @endif
                    </td>
            ...
            <tr>
                ...
                <td class="text-center">
                    {{ Number::currency($subtotal, 'COP', locale: 'es_CO') }}
                </td>
            </tr>
            <tr>
                <th colspan="4" class="align-middle text-end">
            ...
            <tr>
                ...
                <td class="text-center">
                    {{ Number::currency($total, 'COP', locale: 'es_CO') }}
