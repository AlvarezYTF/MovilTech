...
<div class="page-body">
    ...
    <div class="empty">
        ...
        <p class="empty-title">Ho hay ordenes pendientes</p>
                ...
                <table class="table table-bordered card-table table-vcenter text-nowrap datatable">
                    ...
                    @foreach ($orders as $order)
                        <tr>
                            ...
                            <td class="text-center">{{ Number::currency($order->total, 'COP', locale: 'es_CO') }}</td>
                            <td class="text-center">
                                <span class="badge bg-orange text-white text-uppercase">
                                    {{ \App\Enums\OrderStatus::PENDIENTE->label() }}
                                </span>
                            </td>
                            <td class="text-center">
