...
{{--                                            @foreach ($orderDetails as $item)--}}
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    {{ Number::currency($item->unitcost, 'COP', locale: 'es_CO') }}
                                                </td>
                                                <td class="align-middle text-center">
                                                    {{ $item->quantity }}
                                                </td>
                                                <td class="align-middle text-center">
                                                    {{ Number::currency($item->total, 'COP', locale: 'es_CO') }}
                                                </td>
                                            </tr>
                                            @endforeach
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <strong>
                                                        {{ Number::currency($order->sub_total, 'COP', locale: 'es_CO') }}
                                                    </strong>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <strong>
                                                        {{ Number::currency($order->vat, 'COP', locale: 'es_CO') }}
                                                    </strong>
                                                </td>
                                            </tr>
                                            <tr>
