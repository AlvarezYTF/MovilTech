                                ...
                                <div class="card-body">
                                    <div class="row row-cards">
                                        <div class="col-md-12">
                                            ...
                                            <x-input name="name" id="name" placeholder="Nombre del Producto"
                                                value="{{ old('name') }}" />
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <x-input type="number" label="Precio de Compra" name="buying_price"
                                                id="buying_price" placeholder="0" value="{{ old('buying_price') }}" />
                                        </div>

                                        <div class="col-sm-6 col-md-6">
                                            <x-input type="number" label="Precio de Venta" name="selling_price"
                                                id="selling_price" placeholder="0" value="{{ old('selling_price') }}" />
                                        </div>

                                        <div class="col-sm-6 col-md-6">
                                            <x-input type="number" label="Cantidad" name="quantity" id="quantity"
                                                placeholder="0" value="{{ old('quantity') }}" />
                                        </div>

                                        <div class="col-sm-6 col-md-6">
                                            <x-input type="number" label="Alerta de Cantidad" name="quantity_alert"
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="notes" id="notes" rows="5" class="form-control @error('notes') is-invalid @enderror"
                                                    placeholder="Notas del producto"></textarea>
