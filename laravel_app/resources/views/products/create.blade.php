...
<div class="max-w-5xl mx-auto">
    <div class="bg-white rounded-lg shadow">
        ...
        <form method="POST" action="{{ route('products.store') }}" class="p-6 space-y-8" id="product-form">
            @csrf
            ...
            <div class="flex items-center justify-between pt-8 border-t border-gray-200 bg-gray-50 -mx-6 px-6 py-4 rounded-b-lg">
                ...
                <div class="flex space-x-3">
                    ...
                    <button type="submit" 
                            class="inline-flex items-center px-6 py-2.5 border border-transparent text-sm font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200 shadow-sm">
