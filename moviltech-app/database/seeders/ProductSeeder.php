    ...
    public function run(): void
    {
        ...
        $products = [
            [
                ...
                'supplier_id' => $suppliers->where('name', 'TechSupply Pro')->first()->id,
                'quantity' => 10,
                'price' => 999.99,
                'cost_price' => 800.00,
                'status' => 'active',
            ...
            [
                ...
                'sku' => 'SAMS24-256',
                'category_id' => $categories->where('name', 'Teléfonos')->first()->id,
                'supplier_id' => $suppliers->where('name', 'MobileParts Inc')->first()->id,
                'quantity' => 15,
                'price' => 899.99,
                'cost_price' => 720.00,
                'status' => 'active',
            ...
            [
                ...
                'supplier_id' => $suppliers->where('name', 'Accessory World')->first()->id,
                'quantity' => 50,
                'price' => 29.99,
                'cost_price' => 15.00,
                'status' => 'active',
            ...
            [
                ...
                'supplier_id' => $suppliers->where('name', 'Repair Tools Co')->first()->id,
                'quantity' => 12,
                'price' => 149.99,
                'cost_price' => 85.00,
                'status' => 'active',
